...
```
# Важно помнить!
## Репликация не спасает от «человеческого фактора».
## Если пришел запрос DROP TABLE users, он мгновенно исполнится и на мастере, и на реплике.
## Поэтому реплика + регулярные бэкапы — это единственный надежный стандарт.
